...
return (
  <div className="relative w-full py-16  bg-gray-900 transition-colors duration-300 ">
    <div className="container mx-auto px-6 lg:px-12">
      <h1 className="text-center text-3xl sm:text-4xl lg:text-5xl font-bold  text-white leading-tight">
